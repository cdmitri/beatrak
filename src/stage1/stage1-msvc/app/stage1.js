...
//		host: '10.99.149.235',
//		host: 'localhost',
		host: 'postgresql-dep-svc.default.svc.cluster.local',
//		host: '127.0.0.1', 
		port: 50005
 	    });
...
(async () => {
    ...
    let STAGE1_PORT=50006
    let STAGE1_HOST="0.0.0.0"
    app.listen(STAGE1_PORT, STAGE1_HOST);
    //    log.debug(m(`main(): SERVER: ${SERVICE_NAME} server on http://${common.HOST}:${common.LOCAL_SERVER_PORT}`));
        log.debug(m(`main(): SERVER: ${SERVICE_NAME} server on http://${STAGE1_HOST}:${STAGE1_PORT}`));
